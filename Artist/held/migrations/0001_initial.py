...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Singer',
            fields=[
                ('artist_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='held.artist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('singer', models.ManyToManyField(to='held.singer')),
            ],
        ),
    ]
